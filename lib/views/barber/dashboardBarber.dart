...
class DashBoardBarber extends StatefulWidget {
  const DashBoardBarber({super.key});

  @override
  State<DashBoardBarber> createState() => _DashBoardBarberState();
}

class _DashBoardBarberState extends State<DashBoardBarber> {
